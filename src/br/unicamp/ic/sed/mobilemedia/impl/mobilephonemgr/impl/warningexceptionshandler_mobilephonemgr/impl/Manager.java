...
class Manager extends br.unicamp.ic.sed.cosmos.AManager{
	...
	public Manager() {
		...
		this.setRequiredInterfaceType("IExceptionsHandlerCtr", br.unicamp.ic.sed.mobilemedia.impl.mobilephonemgr.impl.warningexceptionhandler.spec.prov.IExceptionsHandlerCtr.class);
	}
