...
import br.unicamp.ic.sed.mobilemedia.impl.mobilephotomgr.impl.mobilephonecontroller.dt.Constants;
...
import br.unicamp.ic.sed.mobilemedia.impl.mobilephotomgr.impl.mobilephonecontroller.spec.req.IAlbumCtr;
...
import br.unicamp.ic.sed.mobilemedia.impl.mobilephotomgr.impl.mobilephonecontroller.spec.req.IPhotoCtr;
...
/*	protected br.unicamp.ic.sed.cosmos.IManager getManager() {
		if(manager == null)
			System.out.println("manager is null");
		return manager;this.getManager();
	}

	protected void setManager(br.unicamp.ic.sed.cosmos.IManager manager2) {
		if(manager2 == null)
