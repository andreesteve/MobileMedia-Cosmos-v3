...
class Manager extends AManagerComposite implements IManager {
	...
	public Manager() {
		...
		IManager mobilePhoneController = br.unicamp.ic.sed.mobilemedia.impl.mobilephotomgr.impl.mobilephonecontroller.impl.ComponentFactory.createInstance();
		IManager connMobPh_ExcHand = br.unicamp.ic.sed.mobilemedia.impl.mobilephotomgr.impl.warningexceptionshandler_mobilephonemgr.impl.ComponentFactory.createInstance();
		IManager warningEHIManager = br.unicamp.ic.sed.mobilemedia.impl.mobilephotomgr.impl.warningexceptionhandler.impl.ComponentFactory.createInstance();
