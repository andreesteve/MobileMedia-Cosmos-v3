...
import br.unicamp.ic.sed.mobilemedia.impl.mobilephotomgr.impl.mobilephonecontroller.spec.dt.ImageData;
import br.unicamp.ic.sed.mobilemedia.impl.mobilephotomgr.impl.mobilephonecontroller.spec.excep.ImageNotFoundException;
import br.unicamp.ic.sed.mobilemedia.impl.mobilephotomgr.impl.mobilephonecontroller.spec.excep.InvalidImageDataException;
import br.unicamp.ic.sed.mobilemedia.impl.mobilephotomgr.impl.mobilephonecontroller.spec.excep.InvalidPhotoAlbumNameException;
import br.unicamp.ic.sed.mobilemedia.impl.mobilephotomgr.impl.mobilephonecontroller.spec.excep.NullAlbumDataReference;
import br.unicamp.ic.sed.mobilemedia.impl.mobilephotomgr.impl.mobilephonecontroller.spec.excep.PersistenceMechanismException;
import br.unicamp.ic.sed.mobilemedia.impl.mobilephotomgr.impl.mobilephonecontroller.spec.excep.UnavailablePhotoAlbumException;
import br.unicamp.ic.sed.mobilemedia.impl.mobilephotomgr.impl.mobilephonecontroller.spec.req.IFilesystemCtr;
...
class IAdapterFilesystem implements IFilesystemCtr {
	...
	public void addNewPhotoToAlbum(String imageName, String imagePath,
		...
		} catch (br.unicamp.ic.sed.mobilemedia.impl.mobilephotomgr.spec.excep.InvalidImageDataException e) {
			throw new InvalidImageDataException( e.getMessage() );
		} catch (br.unicamp.ic.sed.mobilemedia.impl.mobilephotomgr.spec.excep.PersistenceMechanismException e) {
	...
	public void createNewPhotoAlbum(String albumName)
		...
		try {
			...
			throw new PersistenceMechanismException( e.getMessage() );
		} catch (br.unicamp.ic.sed.mobilemedia.impl.mobilephotomgr.spec.excep.InvalidPhotoAlbumNameException e) {
	...
	public void deleteImage(String imageName, String albumName)
		...
		try {
			...
			throw new PersistenceMechanismException( e.getMessage() );
		} catch (br.unicamp.ic.sed.mobilemedia.impl.mobilephotomgr.spec.excep.ImageNotFoundException e) {
	...
	public ImageData getImageInfo(String imageName)
			throws br.unicamp.ic.sed.mobilemedia.impl.mobilephotomgr.impl.mobilephonecontroller.spec.excep.ImageNotFoundException,
		...
		try {
			...
			throw new ImageNotFoundException( e.getMessage() );
		} catch (br.unicamp.ic.sed.mobilemedia.impl.mobilephotomgr.spec.excep.NullAlbumDataReference e) {
			throw new NullAlbumDataReference( e.getMessage() );
		}
	}

	private ImageData converteImageData( br.unicamp.ic.sed.mobilemedia.impl.mobilephotomgr.spec.dt.ImageData imageDT ){
	...
	private br.unicamp.ic.sed.mobilemedia.impl.mobilephotomgr.spec.dt.ImageData converteImageData2( ImageData imageDT ){
		br.unicamp.ic.sed.mobilemedia.impl.mobilephotomgr.spec.dt. ImageData imageData = new br.unicamp.ic.sed.mobilemedia.impl.mobilephotomgr.spec.dt.ImageData( imageDT.getForeignRecordId() , imageDT.getParentAlbumName() , imageDT.getImageLabel() );
	...
	private ImageData[] converteImageDatas( br.unicamp.ic.sed.mobilemedia.impl.mobilephotomgr.spec.dt.ImageData[] imageDTs ){
	...
	public ImageData[] getImages(String albumName)
		...
		} catch (br.unicamp.ic.sed.mobilemedia.impl.mobilephotomgr.spec.excep.UnavailablePhotoAlbumException e) {
