...
package br.unicamp.ic.sed.mobilemedia.impl.filesystemmgr_mobilephotomgr.impl;

import javax.microedition.lcdui.Image;

import br.unicamp.ic.sed.mobilemedia.impl.mobilephotomgr.spec.dt.ImageData;
...
class IFileSystemAdapter implements IFilesystem{
	...
	public ImageData[] getImages ( String albumName ) throws UnavailablePhotoAlbumException{
		...
		br.unicamp.ic.sed.mobilemedia.impl.filesystemmgr.spec.prov.IFilesystem filesystem;
		br.unicamp.ic.sed.cosmos.IManager manager = ComponentFactory.createInstance();
		filesystem = (br.unicamp.ic.sed.mobilemedia.impl.filesystemmgr.spec.prov.IFilesystem)manager.getRequiredInterface("IFilesystem");
		try {
			return this.converteImageDatas( filesystem.getImages(albumName) );
		} catch (br.unicamp.ic.sed.mobilemedia.impl.filesystemmgr.spec.excep.UnavailablePhotoAlbumException e) {
	...
	public void addNewPhotoToAlbum ( String imageName, String imagePath, String albumName ) throws InvalidImageDataException, PersistenceMechanismException{
		...
		} catch (br.unicamp.ic.sed.mobilemedia.impl.filesystemmgr.spec.excep.InvalidImageDataException e) {
			throw new InvalidImageDataException( e );
		} catch (br.unicamp.ic.sed.mobilemedia.impl.filesystemmgr.spec.excep.PersistenceMechanismException e) {
	...
	public void deleteImage ( String imageName, String albumName ) throws PersistenceMechanismException, ImageNotFoundException{
		...
		try {
			...
			throw new PersistenceMechanismException( e );
		} catch (br.unicamp.ic.sed.mobilemedia.impl.filesystemmgr.spec.excep.ImageNotFoundException e) {
	...
	public String[] getAlbumNames (  ){
		...
		br.unicamp.ic.sed.mobilemedia.impl.filesystemmgr.spec.prov.IFilesystem filesystem;
		br.unicamp.ic.sed.cosmos.IManager manager = ComponentFactory.createInstance();
		filesystem = (br.unicamp.ic.sed.mobilemedia.impl.filesystemmgr.spec.prov.IFilesystem)manager.getRequiredInterface("IFilesystem");		return filesystem.getAlbumNames();
	}
	...
	public void createNewPhotoAlbum ( String albumName ) throws PersistenceMechanismException, InvalidPhotoAlbumNameException{
		...
		try {
			...
			throw new PersistenceMechanismException( e );
		} catch (br.unicamp.ic.sed.mobilemedia.impl.filesystemmgr.spec.excep.InvalidPhotoAlbumNameException e) {
	...
	public ImageData getImageInfo(String imageName)
		...
		} catch (br.unicamp.ic.sed.mobilemedia.impl.filesystemmgr.spec.excep.NullAlbumDataReference e) {
	...
	private ImageData converteImageData( br.unicamp.ic.sed.mobilemedia.impl.filesystemmgr.spec.dt.ImageData imageDT ){
	...
	private br.unicamp.ic.sed.mobilemedia.impl.filesystemmgr.spec.dt.ImageData converteImageData2( ImageData imageDT ){
		br.unicamp.ic.sed.mobilemedia.impl.filesystemmgr.spec.dt. ImageData imageData = new br.unicamp.ic.sed.mobilemedia.impl.filesystemmgr.spec.dt.ImageData( imageDT.getForeignRecordId() , imageDT.getParentAlbumName() , imageDT.getImageLabel() );
	...
	private ImageData[] converteImageDatas( br.unicamp.ic.sed.mobilemedia.impl.filesystemmgr.spec.dt.ImageData[] imageDTs ){
